...
public interface ITransactionFinanceService
{
  ...
  //public Task<Result<List<TransactionDataDto>>> GetDateRageTransactionsByAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
